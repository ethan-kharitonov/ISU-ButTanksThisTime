...
namespace ISU_ButTanksThisTime
{
    static class Shop
    {
        ...
        static Shop()
        {
            ...
            pieces[0] = new ShopPiece(BurstCannon.Info, new Vector2(startXPos, 100), 1000);
            pieces[1] = new ShopPiece(TierFourCannon.Info, new Vector2(startXPos + (25 + ShopPiece.Dimensions.X), 100), 750);
            pieces[2] = new ShopPiece(MineDroperCannon.Info, new Vector2(startXPos + 2 * (25 + ShopPiece.Dimensions.X), 100), 900);
