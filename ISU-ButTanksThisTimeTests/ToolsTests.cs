using ISU_ButTanksThisTime;
using Microsoft.Xna.Framework;
using NUnit.Framework;

namespace ISU_ButTanksThisTimeTests
{
    [TestFixture]
    public class ToolsTests
    {
        ...
        public float RotateTowardsVectorTest(float current, Vector2 target, float rotationSpeed) => Tools.RotateTowardsVector(current, target, rotationSpeed);
    }
}